        ...
        for ff = 1 : length(clone_List{1,cc})        
            ...
            switch APP_opt.t3_PlotOpt_C
                case 1      % Cytosol / Membr
                    [Ratio cRGB] = Assign_Value_RGB( mean(clone_List{1,cc}{ff}.CH1.IC(  clone_List{1,cc}{ff}.Mask_mCyto )) , ...
                                                     mean(clone_List{1,cc}{ff}.CH1.IC(  clone_List{1,cc}{ff}.Mask_Memb  )) , V_Min, V_Max, RGB_range );                  
                case 2      % Membr / Cytosol
                    [Ratio cRGB] = Assign_Value_RGB( mean(clone_List{1,cc}{ff}.CH1.IC(  clone_List{1,cc}{ff}.Mask_Memb  )) , ...
                                                     mean(clone_List{1,cc}{ff}.CH1.IC(  clone_List{1,cc}{ff}.Mask_mCyto )) , V_Min, V_Max, RGB_range );                  
                case 3      % Old_PL / New_PL
                    [Ratio cRGB] = Assign_Value_RGB( mean(clone_List{1,cc}{ff}.CH1.IC(  clone_List{1,cc}{ff}.CH1.Mask_PL_1 )) , ...
                                                     mean(clone_List{1,cc}{ff}.CH1.IC(  clone_List{1,cc}{ff}.CH1.Mask_PL_2 )) , V_Min, V_Max, RGB_range );                  
                case 4      % New_PL / Old_PL
                    [Ratio cRGB] = Assign_Value_RGB( mean(clone_List{1,cc}{ff}.CH1.IC(  clone_List{1,cc}{ff}.CH1.Mask_PL_2 )) , ...
                                                     mean(clone_List{1,cc}{ff}.CH1.IC(  clone_List{1,cc}{ff}.CH1.Mask_PL_1 )) , V_Min, V_Max, RGB_range );                                            
                case 5      % Cytosol/ Poles
                    PL_1 = mean(clone_List{1,cc}{ff}.CH1.IC(  clone_List{1,cc}{ff}.CH1.Mask_PL_1 )) ;
                    PL_2 = mean(clone_List{1,cc}{ff}.CH1.IC(  clone_List{1,cc}{ff}.CH1.Mask_PL_2 )) ;                
                    avg_pCyto_Value = mean(clone_List{1,cc}{ff}.CH1.IC(  clone_List{1,cc}{ff}.CH1.Mask_pCyto)) ;
...
for cc = 1 : length(clone_List)
    for ff = 1 : length(clone_List{1,cc})
        if I_max < max( max(clone_List{1,cc}{ff}.CH1.IC))
            I_max = max( max(clone_List{1,cc}{ff}.CH1.IC) );
        end
        if I_min > min( min(clone_List{1,cc}{ff}.CH1.IC))
            I_min = min( min(clone_List{1,cc}{ff}.CH1.IC));
        end 

        % Evaluate the Value and the RGB_Color to apply inside the square
        switch APP_opt.t3_PlotOpt_C
            case 1      % Cytosol / Membr
                Val_A = mean(clone_List{1,cc}{ff}.CH1.IC(  clone_List{1,cc}{ff}.Mask_mCyto )) ;
                Val_B = mean(clone_List{1,cc}{ff}.CH1.IC(  clone_List{1,cc}{ff}.Mask_Memb  )) ;                  
            case 2      % Membr / Cytosol
                Val_A = mean(clone_List{1,cc}{ff}.CH1.IC(  clone_List{1,cc}{ff}.Mask_Memb  )) ;
                Val_B = mean(clone_List{1,cc}{ff}.CH1.IC(  clone_List{1,cc}{ff}.Mask_mCyto )) ;                  
            case 3      % Old_PL / New_PL
                Val_A = mean(clone_List{1,cc}{ff}.CH1.IC(  clone_List{1,cc}{ff}.CH1.Mask_PL_1 )) ;
                Val_B = mean(clone_List{1,cc}{ff}.CH1.IC(  clone_List{1,cc}{ff}.CH1.Mask_PL_2 )) ;                  
            case 4      % New_PL / Old_PL
                Val_A = mean(clone_List{1,cc}{ff}.CH1.IC(  clone_List{1,cc}{ff}.CH1.Mask_PL_2 )) ;
                Val_B = mean(clone_List{1,cc}{ff}.CH1.IC(  clone_List{1,cc}{ff}.CH1.Mask_PL_1 )) ;                                              
            case 5      % Cytosol/ Poles                
                PL_1 = mean(clone_List{1,cc}{ff}.CH1.IC(  clone_List{1,cc}{ff}.CH1.Mask_PL_1 )) ;
                PL_2 = mean(clone_List{1,cc}{ff}.CH1.IC(  clone_List{1,cc}{ff}.CH1.Mask_PL_2 )) ;                
                Val_A = mean(clone_List{1,cc}{ff}.CH1.IC(  clone_List{1,cc}{ff}.CH1.Mask_pCyto)) ;
                Val_B = (PL_1 +  PL_2) /2 ; 
            case 6      % Poles / Cytosol  
                PL_1 = mean(clone_List{1,cc}{ff}.CH1.IC(  clone_List{1,cc}{ff}.CH1.Mask_PL_1 )) ;
                PL_2 = mean(clone_List{1,cc}{ff}.CH1.IC(  clone_List{1,cc}{ff}.CH1.Mask_PL_2 )) ;
...
for cc = 1 : length(clone_List)
    for ff = 1 : length(clone_List{1,cc})        
        ...
        switch APP_opt.t3_PlotOpt_C
            case 1      % Cytosol / Membr
                Ratio = (( mean(clone_List{1,cc}{ff}.CH1.IC( clone_List{1,cc}{ff}.Mask_mCyto))  -V_min) /V_max) /...
                        (( mean(clone_List{1,cc}{ff}.CH1.IC( clone_List{1,cc}{ff}.Mask_Memb ))  -V_min) /V_max) ;
            case 2      % Membr / Cytosol
                Ratio = (( mean(clone_List{1,cc}{ff}.CH1.IC( clone_List{1,cc}{ff}.Mask_Memb ))  -V_min) /V_max) /...
                        (( mean(clone_List{1,cc}{ff}.CH1.IC( clone_List{1,cc}{ff}.Mask_mCyto))  -V_min) /V_max) ;
            case 3      % Old_PL / New_PL
                Ratio = (( mean(clone_List{1,cc}{ff}.CH1.IC( clone_List{1,cc}{ff}.CH1.Mask_PL_1 ))  -V_min) /V_max) /...
                        (( mean(clone_List{1,cc}{ff}.CH1.IC( clone_List{1,cc}{ff}.CH1.Mask_PL_2 ))  -V_min) /V_max) ;
            case 4      % New_PL / Old_PL
                Ratio = (( mean(clone_List{1,cc}{ff}.CH1.IC( clone_List{1,cc}{ff}.CH1.Mask_PL_2 ))  -V_min) /V_max) /...
                        (( mean(clone_List{1,cc}{ff}.CH1.IC( clone_List{1,cc}{ff}.CH1.Mask_PL_1 ))  -V_min) /V_max) ;
            case 5      % Cytosol/ Poles
                Ratio = (( mean(clone_List{1,cc}{ff}.CH1.IC( clone_List{1,cc}{ff}.CH1.Mask_pCyto))  -V_min) /V_max) /...
                        (( clone_List{1,cc}{ff}.CH1.avg_PL_AVG -V_min) /V_max) ;
            case 6      % Poles / Cytosol                    
                Ratio = ( (clone_List{1,cc}{ff}.CH1.avg_PL_AVG  -V_min) /V_max) /...
                        ( (clone_List{1,cc}{ff}.CH1.avg_Cyto    -V_min) /V_max) ;
        end               
        % Ratio Value min-max
        if R_max < Ratio
