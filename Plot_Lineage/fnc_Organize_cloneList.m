...
%
%fnc_Organize_cloneList = extract cell ID of all clones present in clone_List
%   Importantly, we are interested in finding ID of clone that do not 
%   generate any daugther cell, "end of line" in the lineage tree.
%	- CL_s_EndLine : .c_ID end_line clones in string format
%   - CL_n_EndLine : .c_ID end_line clones in numeric format
%   - CL_s_All     : all unique .c_ID in clone_List
%
% -------------------------------------------------------------------------
