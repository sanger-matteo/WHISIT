function cList = Lng_track_polarity(cList, ff, cc, pcd_track)
%
% Lng_track_polarity = reorganize the cell meshes according to the pole
%   orientation between present (ff) and previous (ff-1) frame.
%
% -------------------------------------------------------------------------
...
% -------------------------------------------------------------------------
    ...
    if d1 > d2      
        ...
        temp = flipud( [ cList{1,ff}{1,now_cc}.mesh(:,3) ,...
                         cList{1,ff}{1,now_cc}.mesh(:,4) , ...
                         cList{1,ff}{1,now_cc}.mesh(:,1) , ...
                         cList{1,ff}{1,now_cc}.mesh(:,2) ] );
        cList{1,ff}{1,now_cc}.mesh = temp ; 
